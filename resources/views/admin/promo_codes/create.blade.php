    ...
    <div class="content-wrapper">
        <div class="content">
            ...
            <div class="breadcrumb-wrapper breadcrumb-contacts">
                ...
                {{-- ============================================== --}}
                <div>
                    <h1><i class="mdi mdi-playlist-plus"></i> Add New Promo Code</h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb p-0">
                            ...
                            <li class="breadcrumb-item">
                                <a href="{{ route('super_admin.promo_codes-index') }}"> <i class="mdi mdi-account-group"></i> All Promo Codes </a>
                            </li>
                            <li class="breadcrumb-item" aria-current="page"><i class="mdi mdi-playlist-plus"></i> Add New Promo Code</li>
                        </ol>
                    </nav>
                </div>
                                                ...
                                                {{-- <div class="col-md-6 mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <select name="promo_type" class="custom-select my-1 mr-sm-2 @error('promo_type') is-invalid @enderror">
                                                            ...
                                                            <option value="1" @if (old('promo_type') == '1') selected @endif>Percentage</option>
                                                            <option value="2" @if (old('promo_type') == '2') selected @endif>Amount</option>
                                                        </select>
                                                    </div>
                                                </div> --}}
